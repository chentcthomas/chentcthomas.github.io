...
labels:
  ...
  - Vercel Deployment
  - Playwright Testing
summary: "This is a web app developed for the ICS 314 course at UH Manoa that matches roommates based on interests, major, noise level, and cleanliness."
---
...
<div class="text-center p-4">
  <div class="mb-3">
    <img width="1200px" src="../img/roomiematch/2.png" class="img-thumbnail">
  </div>
  <div>
    <img width="1200px" src="../img/roomiematch/3.png" class="img-thumbnail">
  </div>
</div>
